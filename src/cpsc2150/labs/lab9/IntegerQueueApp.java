...
public class IntegerQueueApp {
    ...
    private static void addToQueue(IQueue<Integer> q) {
    ...
    private static void getNext(IQueue<Integer> q) {
    ...
    private static void peekInQueue(IQueue<Integer> q) {
        if (q.size() == 0) System.out.println("Queue is empty!");
    ...
    private static void peekAtEnd(IQueue<Integer> q) {
        if (q.size() == 0) System.out.println("Queue is empty!");
    ...
    private static void insertInQueue(IQueue<Integer> q) {
        System.out.println("What number to add to the Queue?");
        Integer newNum = in.nextInt();
        ...
        while (invalidPos) {
            ...
            if (newPos > q.size() + 1) System.out.println("Not a valid position in the Queue!");
                ...
                q.insert(newNum, newPos);
                invalidPos = false;
            }
        }
    }

    private static void getFromQueue(IQueue<Integer> q) {
        if (q.size() == 0) System.out.println("Queue is empty!");
            ...
            Integer getVal = q.get(newPos);

            System.out.println(getVal + " is at position " + newPos + " in the queue");
        }
    }

    private static void removeFromQueue(IQueue<Integer> q) {
        if (q.size() == 0) System.out.println("Queue is empty!");
            ...
            Integer remVal = q.remove(newPos);
